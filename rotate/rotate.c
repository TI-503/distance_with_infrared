...
void SetFrq(int frequency)
{
	SetFrequencyOfTimers(TIMERA3_BASE, TIMER_A,
					(TIMER_CFG_SPLIT_PAIR | TIMER_CFG_A_PWM | TIMER_CFG_B_PWM), 1, frequency);//1
	SetFrequencyOfTimers(TIMERA3_BASE, TIMER_B,//6.25=100/16
					(TIMER_CFG_SPLIT_PAIR | TIMER_CFG_A_PWM | TIMER_CFG_B_PWM), 1, frequency);//2
	SetFrequencyOfTimers(TIMERA2_BASE, TIMER_B,//6.25=100/16
					(TIMER_CFG_SPLIT_PAIR | TIMER_CFG_A_CAP_TIME | TIMER_CFG_B_PWM), 1, frequency);//64
}
...
void ConfigureFrq(){
	SetFrequencyOfTimers(TIMERA3_BASE, TIMER_A,
					(TIMER_CFG_SPLIT_PAIR | TIMER_CFG_A_PWM | TIMER_CFG_B_PWM), 1, 10*100);//1
	SetFrequencyOfTimers(TIMERA3_BASE, TIMER_B,//6.25=100/16
					(TIMER_CFG_SPLIT_PAIR | TIMER_CFG_A_PWM | TIMER_CFG_B_PWM), 1, 10*100);//2
	SetFrequencyOfTimers(TIMERA2_BASE, TIMER_B,//6.25=100/16
					(TIMER_CFG_SPLIT_PAIR | TIMER_CFG_A_CAP_TIME | TIMER_CFG_B_PWM), 1, 10*100);//64
}
